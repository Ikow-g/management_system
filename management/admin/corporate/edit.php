                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex align-items-center">
                            <p class="mb-0">Edit Corporate</p>
                        </div>
                    </div>
                    <div class="card-body">
                        <p class="text-uppercase text-sm">Corporate Data</p>
                        <form action="action_edit.php" method="post">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label class="form-control-label">Corporate Name</label>
                                    <input class="form-control" name="corporate" type="text"
                                        placeholder="Corporate Name" value='<?= $data['corporate_name'] ?>' required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group">
